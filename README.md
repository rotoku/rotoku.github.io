...
![Publish GitHub Pages](https://github.com/rotoku/rotoku.github.io/actions/workflows/pages.yml/badge.svg)
...
```
hugo new --kind chapter cloud-computing/_index.html
hugo new --kind chapter cloud-computing/aws/_index.html


hugo new post/welcome.md
hugo new aws/api-gateway.md
hugo new aws/app-sync/_index.md

hugo new --kind chapter bash/_index.md
```
